...
@REM git push -f https://github.com/Shuaiwen-Cui/Maker.git main
git push -f https://github.com/Shuaiwen-Cui/Maker.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Maker.git
